...
__PMU_PFLASH2_BEGIN = 0x800400000;
__PMU_PFLASH2_SIZE  = 2M;
/* Program Flash Memory (PFLASH3) */
__PMU_PFLASH3_BEGIN = 0x80600000;
__PMU_PFLASH4_SIZE = 2M;
...
MEMORY
{
  ...
  /* - Program Flash Memory (PFLASH0) */
  /* PMU_PFLASH0	(rx!p):	org = 0x80000400, len = 1999k */
  /* - Program Flash Memory (PFLASH1) */
  /* PMU_PFLASH1	(rx!p):	org = 0x80200000, len = 2M */

  /* - Program Flash Memory (PFLASH0 + PFLASH1) */
  PMU_PFLASH	(rx!p):	org = 0x80000400, len = 8191k
